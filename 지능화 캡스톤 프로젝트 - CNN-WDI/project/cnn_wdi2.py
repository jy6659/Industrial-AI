...
print("------------------------------")
img_path = train_none_dir+"\\"+train_none_fnames[0]
...
image_datasets = {x: torchvision.datasets.ImageFolder(os.path.join(data_dir, x), data_transforms[x]) for x in ['training', 'testing']}
